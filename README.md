...
TARGETS:
  ...
  +proto [--USERARCH] [--go_version=1.23.0] [--bufbuild_version=1.39.0]
      proto generates gRPC server.
  +buf-registry [--USERARCH] [--go_version=1.23.0] [--bufbuild_version=1.39.0]
  ...
  +lint-proto [--USERARCH] [--go_version=1.23.0] [--bufbuild_version=1.39.0]
